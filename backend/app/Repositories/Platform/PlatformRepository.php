...
class PlatformRepository extends BaseRepository implements PlatformRepositoryInterface
{
    ...
    */
    ...
    {
        $count = $this->model
        ->withCount(['advertisementDetails as advertisement_details_count' => function ($query) use ($userId) {
        ...
        $count_last_month = $this->model
            ->withCount(['advertisementDetails as advertisement_details_count' => function ($query) use ($userId, $currentYear, $currentMonth) {
                $query->with('advertisement')
