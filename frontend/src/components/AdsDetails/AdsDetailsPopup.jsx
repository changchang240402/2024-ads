...
const AdsDetailsPopup = ({ selectedItem, action }) => {
    ...
    return (
        <div className='fixed z-20 top-0 left-0 w-full h-full flex items-center justify-center bg-slate-300 bg-opacity-70'>
            <div className="flex flex-col bg-white px-10 pt-6 rounded-xl">
                ...
                {
                    data?.adsDetails ? (
                        <div className='flex justify-between items-center rounded-xl py-2 w-full'>
                ...
                <div className="flex flex-col w-full justify-center items-center mt-6 font-bold text-xl">
                    <p>
                ...
                </div>
                {
                    data?.platforms && data?.platforms.length === 0 ? (
                        ...
                        <TableVirtuoso className='flex w-full justify-start items-start mt-2'
                            data={data?.platforms}
                            ...
                            itemContent={(index, item) => (
                                <>
                                    ...
                                    <td className='w-1/12 border-b items-center text-center '>
                                        <p className={`px-2 text-white mr-10 ${item.conversionRate > volume ?
